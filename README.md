...
* [x] Improve the user interface and theme the app to feel "twitter branded" Used some blue theme to represent twitter
...
The most difficult challenge was trying to understand the infinite pagination. 
